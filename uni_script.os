// UNI_SCRIPT - универсальный скрипт на языке 1С//	VERSION: 2016.08.11.1
// Версия
// TO-DO
		...
		Для Каждого Строки Из Обновление Цикл
			Если Раздел <> Строки.Раздел Тогда
				Если НЕ ПустаяСтрока(Текст) тогда
					Текст = Текст + "</ul>" + Символы.ПС;
				КонецЕсли;
				Текст = Текст + "<h4>" + Строки.Раздел + "</h4>" + Символы.ПС;
				...
				ИначеЕсли Раздел = "Исправление ошибок" Тогда
					КлассCSS = "upderr";
				КонецЕсли;
				Текст = Текст + "<ul class=""" + КлассCSS + """>" + Символы.ПС;
			КонецЕсли;
			Текст = Текст + "<li>" + Строки.Текст + "</li>" + Символы.ПС;
		КонецЦикла;
		Текст = Текст + "</ul>";
