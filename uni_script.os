...
//*	ЗапуститьCoverage = Параметры["/Coverage"];
//	Если ЗначениеЗаполнено(ЗапуститьCoverage) И НРег(ЗапуститьCoverage) = "true" Тогда
...
//		
//		Попытка
//			Лог.Информация("Принудительный запуск dbgs.exe для включения отладки.");
...
//		КонецПопытки;
//
//		мПараметры.Добавить("/debug" + " " + ТипОтладки + " " + "-attach");
//		мПараметры.Добавить("/debuggerURL" + " " + АдресОтладчика);
//	КонецЕсли;
