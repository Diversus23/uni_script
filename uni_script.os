// UNI_SCRIPT - универсальный скрипт на языке 1С//	VERSION: 2020.11.08.1
// Версия
// TO-DO
...
//				- /N (логин администратора ИБ, если не задан, то без логина)
//				- /P (пароль администратора ИБ)
//				- /Folder <путь> (Путь к папке с выгруженной конфигурацией в файлы)
...
Функция ЗаполнитьПараметры()
	...
	юсПарсер.ДобавитьИменованныйПараметр("/Folder");					// Имя папки
...
//				- /N (логин администратора ИБ, если не задан, то без логина)
//				- /P (пароль администратора ИБ)
//				- /Folder <путь> (Путь к каталогу конфигурации)

	Если НЕ ЗначениеЗаполнено(юсПараметры["/Folder"]) Тогда
		юсСообщить("ERROR", "Не заполнен параметр ""/Folder"" - путь каталогу с файлами конфигурации!");
		Возврат;
	КонецЕсли;
	...
	ПараметрыЗапуска.Добавить("""" + юсПараметры["/Folder"] + """");	
