...
// Пример обращения: /StartCoverage41C /DebugURL http://127.0.0.1:1550 /SrcFiles $CI_PROJECT_DIR\$PROJECT_NAME\src /FilesProject $CI_PROJECT_DIR /FileName $PROJECT_NAME /Settings $CI_PROJECT_DIR\settings.ini /Section SETTINGS
