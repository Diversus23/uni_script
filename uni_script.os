...
//				- Branch - наименование ветки запуска, по данному параметру определяем нужно ли изменять текущую версию на сайте
...
//				- Section
	...
	НазваниеВетки = Параметры["/Branch"];
	Если Не ЗначениеЗаполнено(НазваниеВетки) Тогда
		Лог.Ошибка("Не заполнен параметр ""/Branch"" - наименование ветки запуска");
		КодВозврата = 160;
		Возврат;
	КонецЕсли;
	...
	Если НРег(НазваниеВетки) <> "master" Тогда
		ВерсияНовости = "";
	КонецЕсли;
