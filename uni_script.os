// BSLLS-off
// UNI_SCRIPT - универсальный скрипт на языке 1С VERSION: 2022.06.14
// Версия
// TO-DO
...
Процедура ЗапускVanessaAutomation()
	...
	мПараметрыТестирования = "StartFeaturePlayer;QuietInstallVanessaExt;WorkspaceRoot=" + мПутьКТестам + ";VAParams=" + мНастройки;
