...
Функция ЗаполнитьПараметры()
	...
	Парсер.ДобавитьИменованныйПараметр("/PlatformVersion");				// Используемая версия платформы
...
//				- /
	...
	мПараметры.Добавить("/DisableStartupMessages");
	мПараметры.Добавить("/DisableStartupDialogs");
